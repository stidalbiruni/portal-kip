...
const INITIAL_APPLICANTS: StudentApplicant[] = [
  {
    ...
    berkas: { kartuKip: true, sktm: true, slipGaji: true, raport: true, prestasiDoc: true, ktp: true, kk: true, foto: true },
  ...
  },
  {
    ...
    berkas: { kartuKip: true, sktm: true, slipGaji: true, raport: true, prestasiDoc: false, ktp: true, kk: true, foto: true },
  ...
  },
  {
    ...
    berkas: { kartuKip: false, sktm: true, slipGaji: true, raport: true, prestasiDoc: false, ktp: true, kk: true, foto: true },
  ...
  },
  {
    ...
    berkas: { kartuKip: true, sktm: true, slipGaji: false, raport: true, prestasiDoc: false, ktp: true, kk: true, foto: true },
